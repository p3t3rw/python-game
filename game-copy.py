def game():
    while True:
        ...
        if not end(scrolls):
            break
    print("Welcome to Mario's Adventure!\nIn this game, you will navigate through a world map making choices that will lead you to different levels\nYour goal is to reach the castle\nremember to colect all the MAGIC SCROLLS along the way")
